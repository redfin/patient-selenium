...
/**
 * Base class for the page object and widget object types.
 *
 ...
 */
public abstract class AbstractPsBaseInitializedObject<D extends WebDriver,
     ...
     * be the same as the driver or it could be an element depending on how
     * this was initialized.
     *
     * @throws IllegalStateException if this page object hasn't been initialized.
     */
    protected final FindsElements<D, W, C, P, B, L, E> getSearchContext() {
        return expect().withMessage("This page object has not been initialized by a page object initializer.")
                       .that(pageContext)
                       .isNotNull();
    }
